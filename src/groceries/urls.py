...
urlpatterns = [
    ...
    path('modify/delete/', grocery_delete_overview,
         name="grocery-delete-overview"),
    path('modify/delete/<int:id>/', grocery_delete_object_view,
         name="grocery-delete-object-view"),
    path('modify/update/', grocery_update_overview,
         name="grocery-update-overview"),
    path('modify/update/<int:id>/', grocery_update_object_view,
         name="grocery-update-object-view"),
    ...
    path('grocery_list/settings', grocery_list_settings_view,
